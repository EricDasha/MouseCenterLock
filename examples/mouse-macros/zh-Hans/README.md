...
- `far-far-west-back-left-combo.json`：`x1` 切换 armed 状态，左键触发 → 左键 `mouseDown`、60ms、`mouseUp`、120ms、按下 `2`、80ms、按下 `1`、27ms、松开 `2`、66ms、松开 `1`；取消时自动补 `KeyUp 2/1`。建议 `cooldownMs=450`，避免连续触发撞进切枪冷却。
